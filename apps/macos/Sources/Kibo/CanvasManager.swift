...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.kibo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Kibo/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__kibo__/a2ui/").absoluteString + "?platform=macos"
    }
