...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "kibo/plugin-sdk/webhook-request-guards";
...
vi.mock("kibo/plugin-sdk/reply-runtime", () => ({
...
vi.mock("kibo/plugin-sdk/webhook-ingress", () => ({
