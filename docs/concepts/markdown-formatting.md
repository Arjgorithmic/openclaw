...
Kibo formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** — see [docs](https://github.com/Arjgorithmic/openclaw).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://github.com/Arjgorithmic/openclaw" }]
}
```
