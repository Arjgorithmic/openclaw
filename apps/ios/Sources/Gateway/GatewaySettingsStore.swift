...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.kibo.gateway"
    private static let nodeService = "ai.kibo.node"
    private static let talkService = "ai.kibo.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.kibo.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.kibo.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("kibo-gateway.log")
    }
