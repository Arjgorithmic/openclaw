...
import { resolveApprovalRequestSessionConversation } from "kibo/plugin-sdk/approval-native-runtime";
import type { DiscordExecApprovalConfig, KiboConfig } from "kibo/plugin-sdk/config-runtime";
