...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.kibo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".kibo/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.kiboCommand(
            subcommand: "gateway",
