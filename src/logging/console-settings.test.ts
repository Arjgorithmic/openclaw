...
let originalKiboTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalKiboTestConsole = process.env.KIBO_TEST_CONSOLE;
  process.env.KIBO_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalKiboTestConsole === undefined) {
    delete process.env.KIBO_TEST_CONSOLE;
  } else {
    process.env.KIBO_TEST_CONSOLE = originalKiboTestConsole;
  }
