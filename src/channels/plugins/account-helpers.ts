...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: KiboConfig): string | undefined {
  ...
  function listAccountIds(cfg: KiboConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: KiboConfig): string {
