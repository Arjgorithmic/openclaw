...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: KiboConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: KiboConfig, mode: ChannelAuthMode): string {
