...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): KiboConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: KiboConfig, env: NodeJS.ProcessEnv) =>
