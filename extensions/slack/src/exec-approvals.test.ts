...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<KiboConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<KiboConfig["channels"]>["slack"]>>,
): KiboConfig {
  return {
    channels: {
      slack: {
