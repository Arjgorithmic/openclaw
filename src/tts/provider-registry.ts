...
function resolveSpeechProviderPluginEntries(cfg?: KiboConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: KiboConfig): SpeechProviderPlugin[] {
