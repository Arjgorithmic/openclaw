...
type BuildCommandTextFromArgs =
  typeof import("kibo/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("kibo/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("kibo/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("kibo/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("kibo/plugin-sdk/command-auth").resolveCommandArgMenu;
