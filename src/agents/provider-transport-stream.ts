...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "kibo-openai-responses-transport",
  "openai-codex-responses": "kibo-openai-responses-transport",
  "openai-completions": "kibo-openai-completions-transport",
  "azure-openai-responses": "kibo-azure-openai-responses-transport",
  "anthropic-messages": "kibo-anthropic-messages-transport",
  "google-generative-ai": "kibo-google-generative-ai-transport",
};
