...
export function summarizeExistingConfig(config: KiboConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://github.com/Arjgorithmic/openclaw/gateway/remote",
    "https://github.com/Arjgorithmic/openclaw/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
