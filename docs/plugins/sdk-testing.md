...
summary: "Testing utilities and patterns for Kibo plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Kibo
plugins.
...
**Import:** `kibo/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "kibo/plugin-sdk/testing";
...
1. **No monolithic root imports** -- `kibo/plugin-sdk` root barrel is rejected
...
Kibo uses Vitest with V8 coverage thresholds. For plugin tests:
