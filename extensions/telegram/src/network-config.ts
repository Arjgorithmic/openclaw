...
import { isTruthyEnvValue, isWSL2Sync } from "kibo/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "kibo/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "KIBO_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "KIBO_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "KIBO_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable KIBO_TELEGRAM_DNS_RESULT_ORDER
