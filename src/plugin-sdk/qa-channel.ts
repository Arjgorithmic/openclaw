...
type FacadeModule = typeof import("@kibo/qa-channel/api.js");
import {
...
export type QaBusAttachment = import("@kibo/qa-channel/api.js").QaBusAttachment;
export type QaBusConversation = import("@kibo/qa-channel/api.js").QaBusConversation;
export type QaBusConversationKind = import("@kibo/qa-channel/api.js").QaBusConversationKind;
export type QaBusCreateThreadInput = import("@kibo/qa-channel/api.js").QaBusCreateThreadInput;
export type QaBusDeleteMessageInput = import("@kibo/qa-channel/api.js").QaBusDeleteMessageInput;
export type QaBusEditMessageInput = import("@kibo/qa-channel/api.js").QaBusEditMessageInput;
export type QaBusEvent = import("@kibo/qa-channel/api.js").QaBusEvent;
export type QaBusInboundMessageInput =
  import("@kibo/qa-channel/api.js").QaBusInboundMessageInput;
export type QaBusMessage = import("@kibo/qa-channel/api.js").QaBusMessage;
export type QaBusOutboundMessageInput =
  import("@kibo/qa-channel/api.js").QaBusOutboundMessageInput;
export type QaBusPollInput = import("@kibo/qa-channel/api.js").QaBusPollInput;
export type QaBusPollResult = import("@kibo/qa-channel/api.js").QaBusPollResult;
export type QaBusReactToMessageInput =
  import("@kibo/qa-channel/api.js").QaBusReactToMessageInput;
export type QaBusReadMessageInput = import("@kibo/qa-channel/api.js").QaBusReadMessageInput;
export type QaBusSearchMessagesInput =
  import("@kibo/qa-channel/api.js").QaBusSearchMessagesInput;
export type QaBusStateSnapshot = import("@kibo/qa-channel/api.js").QaBusStateSnapshot;
export type QaBusThread = import("@kibo/qa-channel/api.js").QaBusThread;
export type QaBusWaitForInput = import("@kibo/qa-channel/api.js").QaBusWaitForInput;
