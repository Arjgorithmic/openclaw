    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["kibo directory self --channel slack", "Show the connected account identity."],
          [
            'kibo directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["kibo directory groups list --channel discord", "List available groups/channels."],
          [
            "kibo directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.kibo.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
