...
const providerFilter = parseCsvFilter(process.env.KIBO_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.KIBO_LIVE_MUSIC_GENERATION_MODELS);
