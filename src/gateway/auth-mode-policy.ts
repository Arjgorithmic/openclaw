...
export function hasAmbiguousGatewayAuthModeConfig(cfg: KiboConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: KiboConfig): void {
