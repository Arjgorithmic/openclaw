const DEFAULT_TAGLINE = "All your chats, one Kibo.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little kibo-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew kibos—type something and let the bot pinch the busywork.",
  ...
  "Automation with kibos: minimal fuss, maximal pinch.",
  ...
  "Kibos out, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a shell roll: messy, delicious, effective.",
  "Shell yeah—I'm here to pinch the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only banana in your contacts you actually want to hear from. 🍌",
  ...
  "Built by shells, for humans. Don't question the hierarchy.",
  ...
  "Half butler, half debugger, full companion.",
  ...
  "You had me at 'kibo gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.KIBO_TAGLINE_INDEX;
