import type { resolveProviderHttpRequestConfig } from "kibo/plugin-sdk/provider-http";
...
vi.mock("kibo/plugin-sdk/provider-auth-runtime", () => ({
  resolveApiKeyForProvider: providerHttpMocks.resolveApiKeyForProviderMock,
}));

vi.mock("kibo/plugin-sdk/provider-http", () => ({
