---
summary: "Use Xiaomi MiMo models with Kibo"
read_when:
  - You want Xiaomi MiMo models in Kibo
...
Xiaomi MiMo is the API platform for **MiMo** models. Kibo uses the Xiaomi
...
```bash
kibo onboard --auth-choice xiaomi-api-key
# or non-interactive
kibo onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
