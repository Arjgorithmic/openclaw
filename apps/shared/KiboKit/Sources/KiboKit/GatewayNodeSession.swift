...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.kibo", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.kibo", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: KiboProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
