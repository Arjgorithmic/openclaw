...
const env = {
  ...process.env,
  KIBO_LIVE_TEST: process.env.KIBO_LIVE_TEST || "1",
  KIBO_LIVE_TEST_QUIET: quietOverride ?? process.env.KIBO_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.KIBO_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
