...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.kibo", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.kibo", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [KiboChatMessage] = messages.compactMap { item in
