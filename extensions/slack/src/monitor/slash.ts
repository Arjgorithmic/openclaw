...
import { type ChatCommandDefinition, type CommandArgs } from "kibo/plugin-sdk/command-auth";
import {
...
import { chunkItems, normalizeLowercaseStringOrEmpty } from "kibo/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "kibo_cmdarg";
