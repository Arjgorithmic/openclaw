...
vi.mock("../loader.js", () => ({
  loadKiboPlugins: (...args: unknown[]) => loadKiboPluginsMock(...args),
}));
...
describe("loadPluginMetadataRegistrySnapshot", () => {
  ...
  beforeEach(() => {
    ...
    loadKiboPluginsMock.mockReturnValue({ plugins: [], diagnostics: [] });
  });
  ...
  it("defaults to a non-activating validate snapshot", () => {
    loadPluginMetadataRegistrySnapshot({
      ...
      env: { HOME: "/tmp/kibo-home" } as NodeJS.ProcessEnv,
