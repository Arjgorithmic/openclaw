...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.kibo", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Kibo CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .kiboSelectSettingsTab, object: tab)
        }
    }
