...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = KiboConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = KiboConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: KiboConfigFile.loadDict(),
        ...
        KiboConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/kibo"
        state.remoteCliPath = ""
        return state
    }
}
