...
function mergeZalouserAccountConfig(cfg: KiboConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: KiboConfig; accountId?: string | null }) {
