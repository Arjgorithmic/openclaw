...
} from "kibo/plugin-sdk/browser-node-runtime";
...
export function createBrowserPluginService(): KiboPluginService {
  ...
  return {
    ...
    start: async () => {
      ...
      handle = await startLazyPluginServiceModule({
        skipEnvVar: "KIBO_SKIP_BROWSER_CONTROL_SERVER",
        overrideEnvVar: "KIBO_BROWSER_CONTROL_MODULE",
