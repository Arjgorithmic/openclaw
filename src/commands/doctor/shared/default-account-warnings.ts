...
export function collectMissingDefaultAccountBindingWarnings(cfg: KiboConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: KiboConfig): string[] {
  const warnings: string[] = [];
