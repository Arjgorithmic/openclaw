...
vi.mock("kibo/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/kibo-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.KIBO_STATE_DIR = "/tmp/kibo-test-sticker-cache";
    fs.rmSync("/tmp/kibo-test-sticker-cache", { recursive: true, force: true });
