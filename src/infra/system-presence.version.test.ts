  ...
  return withEnvAsync(
    {
      ...
      KIBO_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when KIBO_VERSION is not set", async () => {
  ...
  it("prefers KIBO_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over KIBO_SERVICE_VERSION when KIBO_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        KIBO_VERSION: " ",
        KIBO_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when KIBO_VERSION and KIBO_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        KIBO_VERSION: " ",
        KIBO_SERVICE_VERSION: "\t",
