...
read_when:
  - You want Zalo Personal (unofficial) support in Kibo
...
Zalo Personal support for Kibo via a plugin, using native `zca-js` to automate a normal Zalo user account.
