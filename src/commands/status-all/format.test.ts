...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://kibo.local")).toBe("https://kibo.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://kibo.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: kibo security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://kibo.local" },
