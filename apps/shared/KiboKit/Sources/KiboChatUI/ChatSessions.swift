...
public struct KiboChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct KiboChatSessionsDefaults: Codable, Sendable {
...
public struct KiboChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct KiboChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: KiboChatSessionsDefaults?
    public let sessions: [KiboChatSessionEntry]
