...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://github.com/Arjgorithmic/openclaw/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("kibo hooks list")}`,
      `  ${formatCliCommand("kibo hooks enable <name>")}`,
      `  ${formatCliCommand("kibo hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
