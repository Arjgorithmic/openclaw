...
import { shouldHandleTextCommands } from "kibo/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "kibo/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "kibo/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "kibo/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "kibo/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "kibo/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "kibo/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("kibo/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("kibo/plugin-sdk/conversation-binding-runtime");
