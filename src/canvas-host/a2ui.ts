...
export const A2UI_PATH = "/__kibo__/a2ui";

export const CANVAS_HOST_PATH = "/__kibo__/canvas";

export const CANVAS_WS_PATH = "/__kibo__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.kiboCanvasA2UIAction.postMessage(...)
  // - Android: window.kiboCanvasA2UIAction.postMessage(...)
  const handlerNames = ["kiboCanvasA2UIAction"];
  ...
  globalThis.Kibo = globalThis.Kibo ?? {};
  globalThis.Kibo.postMessage = postToNode;
  globalThis.Kibo.sendUserAction = sendUserAction;
  globalThis.kiboPostMessage = postToNode;
  globalThis.kiboSendUserAction = sendUserAction;
