...
export function listQQBotAccountIds(cfg: KiboConfig): string[] {
...
export function resolveDefaultQQBotAccountId(cfg: KiboConfig): string {
  const qqbot = cfg.channels?.qqbot as QQBotChannelConfig | undefined;
...
/** Apply account config updates back into the Kibo config object. */
