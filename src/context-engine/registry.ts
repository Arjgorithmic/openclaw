...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("kibo.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("kibo.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: KiboConfig): Promise<ContextEngine> {
