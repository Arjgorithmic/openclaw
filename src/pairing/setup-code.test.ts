...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("KIBO_GATEWAY_TOKEN", "");
    vi.stubEnv("KIBO_GATEWAY_PASSWORD", "");
    vi.stubEnv("KIBO_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses KIBO_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
