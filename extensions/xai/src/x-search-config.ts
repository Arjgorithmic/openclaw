...
export function resolveLegacyXSearchConfig(config?: KiboConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: KiboConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: KiboConfig): JsonRecord | undefined {
