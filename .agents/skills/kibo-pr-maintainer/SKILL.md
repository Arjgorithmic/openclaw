...
- Use `--repo kibo/kibo` with `--match title,body` first.
...
```bash
gh search prs --repo kibo/kibo --match title,body --limit 50 -- "auto-update"
gh search issues --repo kibo/kibo --match title,body --limit 50 -- "auto-update"
gh search issues --repo kibo/kibo --match title,body --limit 50 \
