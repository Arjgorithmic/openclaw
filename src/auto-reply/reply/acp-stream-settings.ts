...
function resolveAcpStreamCoalesceIdleMs(cfg: KiboConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: KiboConfig): number {
...
export function resolveAcpProjectionSettings(cfg: KiboConfig): AcpProjectionSettings {
