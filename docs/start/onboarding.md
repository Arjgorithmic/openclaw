---
summary: "First-run setup flow for Kibo (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Kibo">
...
<Step title="CLI">
  ...
  The app can install the global `kibo` CLI via npm, pnpm, or bun.
