...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.kibo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Kibo windows, but below the system’s pop-up menus.
