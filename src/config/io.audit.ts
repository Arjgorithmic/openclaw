...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.KIBO_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.KIBO_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.KIBO_WATCH_COMMAND),
