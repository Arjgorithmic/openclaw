...
You can point Kibo at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Kibo
...
- [Anthropic provider](/providers/anthropic) - Native Kibo integration with Claude CLI or API keys
