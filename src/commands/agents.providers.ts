...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: KiboConfig): boolean {
...
export function summarizeBindings(cfg: KiboConfig, bindings: AgentBinding[]): string[] {
