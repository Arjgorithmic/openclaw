import type { ChannelSetupAdapter, KiboConfig } from "kibo/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "kibo/plugin-sdk/setup";
...
export function isLineConfigured(cfg: KiboConfig, accountId: string): boolean {
