...
This package contains the **BlueBubbles external channel plugin** for Kibo.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `kibo/plugin-sdk` helpers.
