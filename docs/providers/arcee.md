...
read_when:
  - You want to use Arcee AI with Kibo
...
kibo onboard --auth-choice arceeai-api-key

# Via OpenRouter
kibo onboard --auth-choice arceeai-openrouter
```
...
Kibo currently ships this bundled Arcee catalog:
