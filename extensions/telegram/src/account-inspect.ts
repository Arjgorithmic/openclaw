import { resolveAccountWithDefaultFallback } from "kibo/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "kibo/plugin-sdk/channel-core";
import type { KiboConfig } from "kibo/plugin-sdk/config-runtime";
import { coerceSecretRef } from "kibo/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "kibo/plugin-sdk/config-runtime";
import { resolveDefaultSecretProviderAlias } from "kibo/plugin-sdk/provider-auth";
...
function inspectTokenValue(params: { cfg: KiboConfig; value: unknown }): {
  token: string;
