...
import { hasConfiguredSecretInput } from "kibo/plugin-sdk/setup";
import { asRecord, hasNonEmptyString } from "./comment-shared.js";

function isFeishuDocToolEnabled(cfg: KiboConfig): boolean {
...
export function collectFeishuSecurityAuditFindings(params: { cfg: KiboConfig }) {
