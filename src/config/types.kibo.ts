...
export type KiboConfig = {
  meta?: {
    /** Last Kibo version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Kibo UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const kiboConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = KiboConfig & {
  readonly [kiboConfigStateBrand]?: TState;
};
