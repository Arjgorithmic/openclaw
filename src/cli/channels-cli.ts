    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["kibo channels list", "List configured channels and auth profiles."],
          ["kibo channels status --probe", "Run channel status checks and probes."],
          [
            "kibo channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["kibo channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.kibo.ai/cli/channels",
        )}\n`,
    );
