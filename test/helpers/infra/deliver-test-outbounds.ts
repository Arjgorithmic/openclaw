...
function resolveSignalMaxBytes(cfg: KiboConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: KiboConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
