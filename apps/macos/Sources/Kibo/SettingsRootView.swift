...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .kiboSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? KiboPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? KiboPaths.stateDirURL.path
...
extension Notification.Name {
    static let kiboSelectSettingsTab = Notification.Name("kiboSelectSettingsTab")
}
