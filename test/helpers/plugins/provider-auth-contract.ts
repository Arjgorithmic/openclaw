...
type LoginOpenAICodexOAuth =
  (typeof import("kibo/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("kibo/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("kibo/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("kibo/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("kibo/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("kibo/plugin-sdk/provider-auth-login")>(
    "kibo/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("kibo/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("kibo/plugin-sdk/provider-auth")>(
    "kibo/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
