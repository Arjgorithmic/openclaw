...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile("imessage", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type KiboConfig } from "kibo/plugin-sdk/core";',
    ...
    'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "kibo/plugin-sdk/status-helpers";',
    ...
    'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiKiboConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
  ],
  [bundledPluginFile("googlechat", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID } from "kibo/plugin-sdk/account-id";',
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "kibo/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "kibo/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "kibo/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "kibo/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "kibo/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "kibo/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "kibo/plugin-sdk/channel-status";',
    'export { chunkTextForOutbound } from "kibo/plugin-sdk/text-chunking";',
    'export type { KiboConfig } from "kibo/plugin-sdk/config-runtime";',
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "kibo/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "kibo/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "kibo/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "kibo/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile("matrix", "runtime-api.ts")]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "kibo/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, KiboConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "kibo/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "kibo/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile("nextcloud-talk", "runtime-api.ts")]: [
    'export * from "kibo/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile("telegram", "runtime-api.ts")]: [
    ...
    'export type { KiboPluginService, KiboPluginServiceContext, PluginLogger } from "kibo/plugin-sdk/plugin-entry";',
    'export type { PluginRuntime } from "kibo/plugin-sdk/runtime-store";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "kibo/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "kibo/plugin-sdk/acp-runtime";',
    'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "kibo/plugin-sdk/channel-plugin-common";',
    ...
    'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "kibo/plugin-sdk/channel-status";',
    'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "kibo/plugin-sdk/channel-actions";',
    ...
    'export type { KiboConfig } from "kibo/plugin-sdk/config-runtime";',
    'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeKiboConfig["channels"]>["telegram"] >;',
