---
summary: "Use SOUL.md to give your Kibo agent an actual voice instead of generic assistant sludge"
read_when:
...
Kibo injects it on normal sessions, so it has real weight. If your agent
...
For Kibo, `SOUL.md` is that layer.
...
Path fixed for Kibo workspaces: use `SOUL.md`, not `http://SOUL.md`.
