...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/Arjgorithmic") {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "envelope", title: "Contact", url: "mailto:arjunpdineshofficial@gamil.com")
            }
            ...
            Text("© 2025 Arjgorithmic — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "KiboBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KiboBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "KiboGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KiboGitCommit") as? String) ??
            "unknown"
    }
