...
import type { KiboPluginApi } from "../../../src/plugins/types.js";
...
export function createPluginRegistryFixture(config = {} as KiboConfig) {
  return {
    config,
...
export function registerVirtualTestPlugin(params: {
  ...
  register(this: void, api: KiboPluginApi): void;
}) {
  registerTestPlugin({
