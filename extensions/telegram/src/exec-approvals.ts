...
import { resolveApprovalRequestChannelAccountId } from "kibo/plugin-sdk/approval-native-runtime";
import type { KiboConfig } from "kibo/plugin-sdk/config-runtime";
import type { TelegramExecApprovalConfig } from "kibo/plugin-sdk/config-runtime";
