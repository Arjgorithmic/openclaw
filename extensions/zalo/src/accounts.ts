...
function mergeZaloAccountConfig(cfg: KiboConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: KiboConfig): ResolvedZaloAccount[] {
