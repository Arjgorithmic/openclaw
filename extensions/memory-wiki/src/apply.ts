...
const GENERATED_START = "<!-- kibo:wiki:generated:start -->";
const GENERATED_END = "<!-- kibo:wiki:generated:end -->";
const HUMAN_START = "<!-- kibo:human:start -->";
const HUMAN_END = "<!-- kibo:human:end -->";
