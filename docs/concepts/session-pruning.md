...
Kibo also runs a separate idempotent cleanup for older legacy sessions that
...
Kibo auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Kibo does not override them.
