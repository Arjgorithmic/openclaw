...
type RegisteredLineCardCommand = Parameters<KiboPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: KiboPluginApi): Promise<RegisteredLineCardCommand> {
