...
export function isAcpEnabledByPolicy(cfg: KiboConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: KiboConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: KiboConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: KiboConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: KiboConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: KiboConfig, agentId: string): boolean {
