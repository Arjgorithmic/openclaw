...
import { buildPluginConfigSchema, z, type KiboPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: KiboPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".kibo", "wiki", "main");
}
