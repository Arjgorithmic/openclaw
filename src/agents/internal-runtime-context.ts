export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_KIBO_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_KIBO_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[KIBO_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[KIBO_INTERNAL_CONTEXT_END]]";
