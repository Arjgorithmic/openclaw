...
export async function setupSkills(
  ...
  if (installable.length > 0) {
    ...
    for (const name of selected) {
      ...
      runtime.log(
        `Tip: run \`${formatCliCommand("kibo doctor")}\` to review skills + requirements.`,
      );
      runtime.log("Docs: https://github.com/Arjgorithmic/openclaw/skills");
    }
  }
