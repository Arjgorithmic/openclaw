...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: KiboConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: KiboConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Kibo has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: KiboConfig; accountId?: string }) =>
