import { resolveApprovalApprovers } from "kibo/plugin-sdk/approval-auth-runtime";
import {
  createChannelExecApprovalProfile,
  isChannelExecApprovalTargetRecipient,
} from "kibo/plugin-sdk/approval-client-runtime";
import { doesApprovalRequestMatchChannelAccount } from "kibo/plugin-sdk/approval-native-runtime";
import type { KiboConfig } from "kibo/plugin-sdk/config-runtime";
import { normalizeStringifiedOptionalString } from "kibo/plugin-sdk/text-runtime";
...
function resolveSlackOwnerApprovers(cfg: KiboConfig): string[] {
