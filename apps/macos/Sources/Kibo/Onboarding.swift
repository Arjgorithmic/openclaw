...
enum UIStrings {
    static let welcomeTitle = "Welcome to Kibo"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "kibo.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: KiboChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g kibo@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: KiboChatViewModel(
