...
const SANDBOX_EXAMPLES = {
  main: [
    ["kibo sandbox list", "List all sandbox containers."],
    ["kibo sandbox list --browser", "List only browser containers."],
    ["kibo sandbox recreate --all", "Recreate all containers."],
    ["kibo sandbox recreate --session main", "Recreate a specific session."],
    ["kibo sandbox recreate --agent mybot", "Recreate agent containers."],
    ["kibo sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["kibo sandbox list", "List all sandbox containers."],
    ["kibo sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["kibo sandbox recreate --all", "Recreate all containers."],
    ["kibo sandbox recreate --session main", "Recreate a specific session."],
    ["kibo sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["kibo sandbox recreate --browser --all", "Recreate only browser containers."],
    ["kibo sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["kibo sandbox explain", "Show effective sandbox config."],
    ["kibo sandbox explain --session agent:main:main", "Explain a specific session."],
    ["kibo sandbox explain --agent work", "Explain an agent sandbox."],
    ["kibo sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.kibo.ai/cli/sandbox")}\n`,
    )
    .action(() => {
