...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.kibo.ios", category: "LiveActivity")
    private var currentActivity: Activity<KiboActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = KiboActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<KiboActivityAttributes>.activities
    ...
    private func updateCurrent(state: KiboActivityAttributes.ContentState) {
    ...
    private func connectingState() -> KiboActivityAttributes.ContentState {
        KiboActivityAttributes.ContentState(
    ...
    private func idleState() -> KiboActivityAttributes.ContentState {
        KiboActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> KiboActivityAttributes.ContentState {
        KiboActivityAttributes.ContentState(
