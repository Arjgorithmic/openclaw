...
import { normalizeScpRemoteHost } from "kibo/plugin-sdk/host-runtime";
import { waitForTransportReady } from "kibo/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "kibo/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "kibo/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "kibo/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "kibo/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "kibo/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "kibo/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "kibo/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "kibo/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T kibo@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., kibo@192.168.64.3)
