...
type LoadedConfig = ReturnType<typeof import("kibo/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("kibo/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("kibo/plugin-sdk/runtime-env").createSubsystemLogger>;
