...
export const OPTIONAL_BUNDLED_BUILD_ENV = "KIBO_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.kibo?.install?.npmSpec === "string" &&
    packageJson.kibo.install.npmSpec.trim().length > 0
  );
}
