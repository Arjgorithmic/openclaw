---
summary: "CLI reference for `kibo health` (gateway health snapshot via RPC)"
read_when:
...
- Default `kibo health` asks the running gateway for its health snapshot. When the
