...
This page ties together how Kibo handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Kibo keeps a
...
Kibo separates the **prompt body** from the **command body**:
...
Kibo can expose or hide model reasoning:
