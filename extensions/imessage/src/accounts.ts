...
function mergeIMessageAccountConfig(cfg: KiboConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: KiboConfig): ResolvedIMessageAccount[] {
