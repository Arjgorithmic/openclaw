...
public enum KiboCanvasA2UICommand: String, Codable, Sendable {
...
public struct KiboCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct KiboCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
