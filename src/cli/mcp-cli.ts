...
import { serveKiboChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Kibo MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Kibo channels over MCP stdio")
