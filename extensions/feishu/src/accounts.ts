import {
  DEFAULT_ACCOUNT_ID,
  type KiboConfig as KibobotConfig,
  createAccountListHelpers,
  normalizeAccountId,
  normalizeOptionalAccountId,
  resolveMergedAccountConfig,
} from "kibo/plugin-sdk/account-resolution";
import { coerceSecretRef } from "kibo/plugin-sdk/provider-auth";
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: KibobotConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: KibobotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: KibobotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: KibobotConfig): ResolvedFeishuAccount[] {
