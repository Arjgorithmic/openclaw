...
import type { PluginConfigUiHint, KiboPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: KiboPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): KiboPluginConfigSchema {
  return {
