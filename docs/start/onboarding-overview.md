---
summary: "Overview of Kibo onboarding options and flows"
read_when:
...
Kibo has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `kibo onboard`                     | Launch the app            |
...
CLI command docs: [`kibo onboard`](/cli/onboard)

## macOS app onboarding

Open the Kibo app. The first-run wizard walks you through the same steps
