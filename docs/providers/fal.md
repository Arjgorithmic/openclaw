---
title: "fal"
summary: "fal image and video generation setup in Kibo"
read_when:
  - You want to use fal image generation in Kibo
...
Kibo ships a bundled `fal` provider for hosted image and video generation.
...
```bash
kibo onboard --auth-choice fal-api-key
```
