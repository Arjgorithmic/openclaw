...
# Output:
# - dist/Kibo.app
# - dist/Kibo-<version>.zip
# - dist/Kibo-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.kibo.mac}"
...
ZIP="$ROOT_DIR/dist/Kibo-$VERSION.zip"
DMG="$ROOT_DIR/dist/Kibo-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Kibo-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Kibo-$VERSION.dSYM.zip"
