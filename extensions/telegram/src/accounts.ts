...
import { formatSetExplicitDefaultInstruction } from "kibo/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "kibo/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.KIBO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: KiboConfig): string[] {
...
export function listTelegramAccountIds(cfg: KiboConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: KiboConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/kibo/kibo/issues/30673
...
export function listEnabledTelegramAccounts(cfg: KiboConfig): ResolvedTelegramAccount[] {
