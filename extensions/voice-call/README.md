...
Official Voice Call plugin for **Kibo**.
...
Docs: `https://github.com/Arjgorithmic/openclaw/plugins/voice-call`
Plugin system: `https://github.com/Arjgorithmic/openclaw/plugin`

## Install (local dev)

### Option A: install via Kibo (recommended)
...
- If older configs still use `provider: "log"`, `twilio.from`, or legacy `streaming.*` OpenAI keys, run `kibo doctor --fix` to rewrite them.
- advanced webhook, streaming, and tunnel notes: `https://github.com/Arjgorithmic/openclaw/plugins/voice-call`
...
`https://github.com/Arjgorithmic/openclaw/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://github.com/Arjgorithmic/openclaw/plugins/voice-call#tts-for-calls`

## CLI

```bash
kibo voicecall call --to "+15555550123" --message "Hello from Kibo"
kibo voicecall continue --call-id <id> --message "Any questions?"
kibo voicecall speak --call-id <id> --message "One moment"
