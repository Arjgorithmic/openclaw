...
import { recordChannelActivity } from "kibo/plugin-sdk/infra-runtime";
import { maxBytesForKind } from "kibo/plugin-sdk/media-runtime";
import { extensionForMime } from "kibo/plugin-sdk/media-runtime";
import { unlinkIfExists } from "kibo/plugin-sdk/media-runtime";
import type { PollInput } from "kibo/plugin-sdk/media-runtime";
import { resolveChunkMode } from "kibo/plugin-sdk/reply-chunking";
import type { RetryConfig } from "kibo/plugin-sdk/retry-runtime";
import { resolvePreferredKiboTmpDir } from "kibo/plugin-sdk/temp-path";
import { convertMarkdownTables, normalizeOptionalString } from "kibo/plugin-sdk/text-runtime";
import { loadWebMediaRaw } from "kibo/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredKiboTmpDir();
