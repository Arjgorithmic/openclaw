...
async function resolveContext(config: KiboConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): KiboConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
