...
import ai.kibo.app.ui.mobileAccentBorderStrong
...
import ai.kibo.app.ui.mobileSurface
import ai.kibo.app.ui.mobileText
import ai.kibo.app.ui.mobileTextSecondary
import ai.kibo.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.kibo.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.kibo.app.ui.mobileFontFamily,
