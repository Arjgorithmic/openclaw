...
import type { SessionBindingRecord } from "kibo/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "kibo/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "kibo/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("kibo/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("kibo/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("kibo/plugin-sdk/config-runtime").KiboConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
