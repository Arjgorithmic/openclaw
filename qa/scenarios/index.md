...
agent:
  identityMarkdown: |-
    ...
    You are the Kibo QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Kibo repo from source + docs before acting.
  ...
  - Include a Kibo Shell Invaders build task.
