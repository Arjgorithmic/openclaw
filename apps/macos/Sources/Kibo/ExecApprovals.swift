...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.kibo", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        KiboPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        KiboPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
