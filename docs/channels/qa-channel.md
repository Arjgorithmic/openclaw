---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic Kibo QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Kibo QA.
...
- Kibo-native orchestration later
