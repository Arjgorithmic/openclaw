...
import type { NativeCommandSpec } from "kibo/plugin-sdk/command-auth";
import type { KiboConfig } from "kibo/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "kibo/plugin-sdk/plugin-runtime";
...
vi.mock("kibo/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("kibo/plugin-sdk/plugin-runtime")>(
    "kibo/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
...
vi.mock("kibo/plugin-sdk/reply-runtime", async () => {
  const actual = await vi.importActual<typeof import("kibo/plugin-sdk/reply-runtime")>(
...
async function createNativeCommand(cfg: KiboConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: KiboConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: KiboConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("kibo/plugin-sdk/plugin-runtime")
    >("kibo/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("kibo/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("kibo/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("kibo/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
