export type ThemeName = "kibo" | "knot" | "dash";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["kibo", "knot", "dash"]);
...
const LEGACY_MAP: Record<string, ThemeSelection> = {
  defaultTheme: { theme: "kibo", mode: "dark" },
  docsTheme: { theme: "kibo", mode: "light" },
  lightTheme: { theme: "knot", mode: "dark" },
  landingTheme: { theme: "knot", mode: "dark" },
  newTheme: { theme: "knot", mode: "dark" },
  dark: { theme: "kibo", mode: "dark" },
  light: { theme: "kibo", mode: "light" },
  openknot: { theme: "knot", mode: "dark" },
  fieldmanual: { theme: "dash", mode: "dark" },
  kiboash: { theme: "dash", mode: "light" },
  system: { theme: "kibo", mode: "system" },
};
