---
summary: "Use Qianfan's unified API to access many models in Kibo"
read_when:
...
3. Kibo installed on your system
...
4. Copy the API key for use with Kibo

## CLI setup

```bash
kibo onboard --auth-choice qianfan-api-key
```
...
- [Kibo Configuration](/gateway/configuration)
