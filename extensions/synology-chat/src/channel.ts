/**
 * Synology Chat Channel Plugin for Kibo.
 *
...
import { createChatChannelPlugin, type ChannelPlugin } from "kibo/plugin-sdk/channel-core";
...
import { createEmptyChannelDirectoryAdapter } from "kibo/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "kibo pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: KiboConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: KiboConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Kibo",
        order: 90,
      },
      capabilities: {
