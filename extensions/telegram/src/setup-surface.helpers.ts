...
export function shouldShowTelegramDmAccessWarning(cfg: KiboConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`kibo config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`kibo config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
