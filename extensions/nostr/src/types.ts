...
import { normalizeSecretInputString, type SecretInput } from "kibo/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: KiboConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: KiboConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: KiboConfig): string {
