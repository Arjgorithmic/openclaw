...
import { attachKiboTranscriptMeta, readSessionMessages } from "./session-utils.js";
...
export type SessionHistoryMessage = Record<string, unknown> & {
  __kibo?: SessionHistoryTranscriptMeta;
};
...
export class SessionHistorySseState {
  ...
  appendInlineMessage(update: {
    ...
    const nextMessage = attachKiboTranscriptMeta(update.message, {
