...
enum DebugActions {
    private static let verboseDefaultsKey = "kibo.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "kibo.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Kibo", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = KiboPaths.configURL
        guard
