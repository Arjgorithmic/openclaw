...
export DISPLAY=:1
export HOME=/tmp/kibo-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${KIBO_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${KIBO_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${KIBO_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${KIBO_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${KIBO_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${KIBO_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${KIBO_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${KIBO_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${KIBO_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${KIBO_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${KIBO_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${KIBO_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
