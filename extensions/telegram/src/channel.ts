...
import { clearAccountEntryFields, createChatChannelPlugin } from "kibo/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "kibo/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "kibo/plugin-sdk/channel-policy";
...
} from "kibo/plugin-sdk/outbound-runtime";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as KiboConfig;
