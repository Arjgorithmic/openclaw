...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "kibo/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("kibo.feishuThreadBindingsState");
