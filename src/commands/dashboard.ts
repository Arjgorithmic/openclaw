...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set KIBO_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `kibo dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Kibo.");
  } else if (hint) {
    runtime.log(hint);
  }
}
