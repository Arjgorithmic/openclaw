import type { ChannelDoctorLegacyConfigRule } from "kibo/plugin-sdk/channel-contract";
...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  {
    path: ["talk"],
    message:
      "talk.voiceId/talk.voiceAliases/talk.modelId/talk.outputFormat/talk.apiKey are legacy; use talk.providers.<provider> and run kibo doctor --fix.",
