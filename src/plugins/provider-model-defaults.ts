...
export function applyGoogleGeminiModelDefault(cfg: KiboConfig): {
  next: KiboConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: KiboConfig): KiboConfig {
...
export function applyOpenAIConfig(cfg: KiboConfig): KiboConfig {
...
export function applyOpencodeGoModelDefault(cfg: KiboConfig): {
  next: KiboConfig;
  changed: boolean;
} {
