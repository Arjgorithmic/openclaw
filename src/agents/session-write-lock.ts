...
const CLEANUP_STATE_KEY = Symbol.for("kibo.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("kibo.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("kibo.sessionWriteLockWatchdogState");
