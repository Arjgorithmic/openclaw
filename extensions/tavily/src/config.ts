...
export function resolveTavilySearchConfig(cfg?: KiboConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: KiboConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: KiboConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
