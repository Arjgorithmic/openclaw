---
summary: "Use Z.AI (GLM models) with Kibo"
read_when:
  - You want Z.AI / GLM models in Kibo
...
for authentication. Create your API key in the Z.AI console. Kibo uses the `zai` provider
with a Z.AI API key.
...
Kibo currently seeds the bundled `zai` provider with:
