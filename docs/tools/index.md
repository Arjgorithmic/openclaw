---
summary: "Kibo tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Kibo provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Kibo), others are **external** (published on npm by the community).
...
These tools ship with Kibo and are available without installing any plugins:
...
- [Kibo Shell](/tools/shell) — typed workflow runtime with resumable approvals
...
| `group:kibo`   | All built-in Kibo tools (excludes plugin tools)                                                       |
