...
vi.mock("kibo/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("kibo/plugin-sdk/channel-pairing", () => ({
...
vi.mock("kibo/plugin-sdk/command-auth", () => ({
...
vi.mock("kibo/plugin-sdk/group-access", () => ({
...
vi.mock("kibo/plugin-sdk/routing", () => ({
