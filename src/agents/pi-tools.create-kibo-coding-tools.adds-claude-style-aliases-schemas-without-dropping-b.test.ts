...
const defaultTools = createKiboCodingTools({ senderIsOwner: true });

describe("createKiboCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const disabledOpenAiTools = createKiboCodingTools({
    ...
    const anthropicTools = createKiboCodingTools({
      config: disabledConfig,
    ...
    const allowModelsConfig: KiboConfig = {
      tools: {
        exec: {
    ...
    const allowed = createKiboCodingTools({
    ...
    const denied = createKiboCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
    ...
    const oauthTools = createKiboCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
