...
import { replaceConfigFile, type KiboConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: KiboConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as KiboConfig;
  ...
  // May trigger loadKiboPlugins on cache miss (disk scan + jiti import)
