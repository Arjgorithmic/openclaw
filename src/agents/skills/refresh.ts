...
function resolveWatchPaths(workspaceDir: string, config?: KiboConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: KiboConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: KiboConfig }) {
