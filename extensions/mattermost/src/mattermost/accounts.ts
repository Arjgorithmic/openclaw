import { createAccountListHelpers } from "kibo/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "kibo/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "kibo/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: KiboConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: KiboConfig): string {
...
export function listEnabledMattermostAccounts(cfg: KiboConfig): ResolvedMattermostAccount[] {
