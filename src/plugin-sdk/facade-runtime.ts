...
const KIBO_SOURCE_EXTENSIONS_ROOT = path.resolve(KIBO_PACKAGE_ROOT, "extensions");
...
function resolveSourceFirstPublicSurfacePath(params: {
  ...
  const sourceRoot = params.bundledPluginsDir ?? path.resolve(KIBO_PACKAGE_ROOT, "extensions");
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: KIBO_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
