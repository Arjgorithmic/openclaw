...
vi.mock("kibo/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("kibo/plugin-sdk/retry-runtime")>(
    "kibo/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
