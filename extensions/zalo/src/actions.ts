import { jsonResult, readStringParam } from "kibo/plugin-sdk/channel-actions";
import type {
...
import { extractToolSend } from "kibo/plugin-sdk/tool-send";
...
function listEnabledAccounts(cfg: KiboConfig, accountId?: string | null) {
  return (
