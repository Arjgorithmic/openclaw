...
public typealias KiboPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias KiboPlatformImage = UIImage
#endif

public struct KiboChatUsageCost: Codable, Hashable, Sendable {
...
public struct KiboChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: KiboChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(KiboChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct KiboChatMessageContent: Codable, Hashable, Sendable {
...
public struct KiboChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [KiboChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: KiboChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [KiboChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: KiboChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(KiboChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([KiboChatMessageContent].self, forKey: .content) {
...
public struct KiboChatHistoryPayload: Codable, Sendable {
...
public struct KiboSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct KiboSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [KiboSessionPreviewItem]
}

public struct KiboSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [KiboSessionPreviewEntry]

    public init(ts: Int, previews: [KiboSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct KiboChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct KiboChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct KiboAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct KiboChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct KiboGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct KiboPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: KiboPlatformImage?
...
public struct KiboChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
