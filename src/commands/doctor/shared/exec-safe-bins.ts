...
function collectExecSafeBinScopes(cfg: KiboConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: KiboConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: KiboConfig): {
  config: KiboConfig;
  changes: string[];
  warnings: string[];
} {
