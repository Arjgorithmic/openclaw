...
} from "kibo/plugin-sdk/memory-core-host-engine-embeddings";
import { resolveUserPath } from "kibo/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "kibo/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall Kibo (this should install node-llama-cpp): npm i -g kibo@latest"
      : null,
