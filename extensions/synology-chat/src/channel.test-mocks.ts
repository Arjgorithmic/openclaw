...
vi.mock("kibo/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("kibo/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("kibo/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("kibo/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("kibo/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("kibo/plugin-sdk/webhook-ingress");
  return {
    ...actual,
