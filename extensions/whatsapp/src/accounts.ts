...
import type { DmPolicy, GroupPolicy } from "kibo/plugin-sdk/config-runtime";
...
export function listWhatsAppAuthDirs(cfg: KiboConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: KiboConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: KiboConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: KiboConfig): ResolvedWhatsAppAccount[] {
