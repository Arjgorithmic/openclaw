...
function resolveKiboVersion(): string {
  try {
 ...
 * and appends the Kibo version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Kibo/<kibo-version>"
 * Example: "teams.ts[apps]/2.0.5 Kibo/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Kibo/${resolveKiboVersion()}`;
  return cachedUserAgent;
}
