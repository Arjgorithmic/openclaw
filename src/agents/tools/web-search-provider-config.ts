...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<KiboConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<KiboConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: KiboConfig): WebSearchConfig {
