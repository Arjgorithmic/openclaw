...
import { collectProviderDangerousNameMatchingScopes } from "kibo/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: KiboConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: KiboConfig,
  doctorFixCommand: string,
): { config: KiboConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: KiboConfig): string[] {
