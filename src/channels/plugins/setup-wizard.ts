...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: KiboConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: KiboConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: KiboConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: KiboConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: KiboConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: KiboConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: KiboConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: KiboConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: KiboConfig) => KiboConfig;
