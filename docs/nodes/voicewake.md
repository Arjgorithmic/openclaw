...
Kibo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.kibo/settings/voicewake.json`

Shape:

```json
{ "triggers": ["kibo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
