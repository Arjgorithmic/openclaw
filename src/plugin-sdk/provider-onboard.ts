...
export type { KiboConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: KiboConfig, ...args: TArgs) => KiboConfig;
  applyConfig: (cfg: KiboConfig, ...args: TArgs) => KiboConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: KiboConfig, preset: TParams) => KiboConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: KiboConfig): {
  next: KiboConfig;
  changed: boolean;
} {
