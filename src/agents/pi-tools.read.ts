...
// NOTE(kibo): Upstream read now does file-magic MIME detection; we keep the wrapper
...
function resolveAdaptiveReadMaxBytes(options?: KiboReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createKiboReadTool(base, {
...
export function createKiboReadTool(
  base: AnyAgentTool,
  options?: KiboReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
