...
- Code: `.agents/skills/kibo-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Flow:
  - Install a KiboHub or gateway-managed skill.
...
- Code: `src/agents/kibo-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
