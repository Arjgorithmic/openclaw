...
const ENV_PROVIDER = "KIBO_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "KIBO_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "KIBO_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "KIBO_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "KIBO_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "KIBO_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "KIBO_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "KIBO_CONTROL_UI_I18N_PROMPT_TIMEOUT";
