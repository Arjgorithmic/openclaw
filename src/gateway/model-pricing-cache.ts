...
export function collectConfiguredModelPricingRefs(config: KiboConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: KiboConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
