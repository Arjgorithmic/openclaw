...
import { safeParseJsonWithSchema, safeParseWithSchema } from "kibo/plugin-sdk/extension-shared";
import { isSecretRef } from "kibo/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: KiboConfig): ResolvedGoogleChatAccount[] {
