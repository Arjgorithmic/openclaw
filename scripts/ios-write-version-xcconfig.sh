...
- KIBO_IOS_VERSION = exact canonical iOS version
- KIBO_MARKETING_VERSION = short iOS/App Store version
- KIBO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
KIBO_IOS_VERSION = ${IOS_VERSION}
KIBO_MARKETING_VERSION = ${MARKETING_VERSION}
KIBO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
