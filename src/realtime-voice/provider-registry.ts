...
function resolveRealtimeVoiceProviderEntries(cfg?: KiboConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: KiboConfig): RealtimeVoiceProviderPlugin[] {
