...
public enum KiboTalkCommand: String, Codable, Sendable {
...
public struct KiboTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct KiboTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
