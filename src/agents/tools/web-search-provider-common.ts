...
export type SearchConfigRecord = (NonNullable<KiboConfig["tools"]>["web"] extends infer Web
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://github.com/Arjgorithmic/openclaw/tools/web";
