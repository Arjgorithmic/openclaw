...
import type { KiboPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = KiboPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("kibo.pluginCommandsState");
