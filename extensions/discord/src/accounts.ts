...
import type { DiscordAccountConfig, DiscordActionConfig, KiboConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: KiboConfig): ResolvedDiscordAccount[] {
