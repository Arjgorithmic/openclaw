...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@kibo", { botUsername: "kibo" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@kibo args", {
        botUsername: "kibo",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "kibo" })).toBe(
      "/help@otherbot",
    );
  });
