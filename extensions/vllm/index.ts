...
async function loadProviderSetup() {
  return await import("kibo/plugin-sdk/provider-setup");
}
  ...
  register(api: KiboPluginApi) {
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set VLLM_API_KEY (any value works) or run "kibo configure". ' +
        "See: https://github.com/Arjgorithmic/openclaw/providers/vllm",
    });
  },
});
