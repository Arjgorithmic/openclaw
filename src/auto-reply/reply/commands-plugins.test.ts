...
vi.mock("../../cli/plugins-command-helpers.js", () => ({
  buildPreferredKiboHubSpec: vi.fn(() => null),
  createPluginInstallLogger: vi.fn(() => ({})),
  decidePreferredKiboHubFallback: vi.fn(() => "fallback_to_npm"),
...
vi.mock("../../infra/kibohub.js", () => ({
  parseKiboHubPluginSpec: vi.fn(() => null),
}));

vi.mock("../../plugins/kibohub.js", () => ({
  installPluginFromKiboHub: vi.fn(),
}));
...
vi.mock("../../plugins/toggle-config.js", () => ({
  setPluginEnabledInConfig: vi.fn((config: KiboConfig, id: string, enabled: boolean) => ({
    ...config,
    plugins: {
      ...config.plugins,
      entries: {
