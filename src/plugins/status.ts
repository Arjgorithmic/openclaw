...
import { normalizeKiboVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeKiboVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeKiboVersionBase(plugin.version) ??
    plugin.version
  );
}
