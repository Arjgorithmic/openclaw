...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: KiboConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: KiboConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: KiboConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: KiboConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: KiboConfig }): Promise<void> {
