...
import { mediaKindFromMime } from "kibo/plugin-sdk/media-runtime";
import { withTempDownloadPath } from "kibo/plugin-sdk/temp-path";
...
function createConfiguredFeishuMediaClient(params: { cfg: KibobotConfig; accountId?: string }): {
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "kibo-feishu-resource-",
