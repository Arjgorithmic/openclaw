...
function resolveQianfanPreset(cfg: KiboConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: KiboConfig): KiboConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: KiboConfig): KiboConfig {
