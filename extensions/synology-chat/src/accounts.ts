...
import { resolveDangerousNameMatchingEnabled } from "kibo/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full Kibo config object. */
function getChannelConfig(cfg: KiboConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: KiboConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.KIBO_BOT_NAME ?? "Kibo";
