...
>({
  ...
  resolveParams: (_cfg: KiboConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: KiboConfig): KiboConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: KiboConfig): KiboConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: KiboConfig): KiboConfig {
