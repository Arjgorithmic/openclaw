...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: KiboProtocol.AnyCodable]?
    {
        ...
        return [
            "id": KiboProtocol.AnyCodable(identity.deviceId),
            "publicKey": KiboProtocol.AnyCodable(publicKey),
            "signature": KiboProtocol.AnyCodable(signature),
            "signedAt": KiboProtocol.AnyCodable(signedAtMs),
            "nonce": KiboProtocol.AnyCodable(nonce),
        ]
    }
}
