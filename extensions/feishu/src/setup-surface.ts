...
function getScopedFeishuConfig(cfg: KiboConfig, accountId: string): ScopedFeishuConfig {
...
function isFeishuConfigured(cfg: KiboConfig, accountId?: string | null): boolean {
