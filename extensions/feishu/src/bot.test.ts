import type * as ConversationRuntime from "kibo/plugin-sdk/conversation-runtime";
...
async function dispatchMessage(params: { cfg: KibobotConfig; event: FeishuMessageEvent }) {
