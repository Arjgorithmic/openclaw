...
let createKiboTools: typeof import("./kibo-tools.js").createKiboTools;

const WORKSPACE_ROOT = "/tmp/kibo-workspace-nodes-guard";

describe("createKiboTools nodes workspace guard", () => {
  beforeAll(async () => {
    vi.resetModules();
    ({ createKiboTools } = await import("./kibo-tools.js"));
  });
