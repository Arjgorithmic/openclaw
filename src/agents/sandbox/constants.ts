...
export const DEFAULT_SANDBOX_IMAGE = "kibo-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "kibo-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "kibo-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "kibo-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "kibo-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "kibo-sandbox-browser";
