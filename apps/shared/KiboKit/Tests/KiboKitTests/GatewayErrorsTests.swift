...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "kibo devices approve req-123",
            docsURLString: "https://github.com/Arjgorithmic/openclaw/gateway/pairing",
        ...
        #expect(error.actionCommand == "kibo devices approve req-123")
        #expect(error.docsURLString == "https://github.com/Arjgorithmic/openclaw/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "kibo devices approve req-123")
    }
