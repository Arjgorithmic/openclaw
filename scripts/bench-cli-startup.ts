...
function printUsage(): void {
  console.log(`Kibo CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: kibo.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "kibo-cli-bench-"));
