...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = KiboChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = KiboChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
