...
import type { KiboPluginApi } from "../plugins/types.js";
...
export type { KiboPluginToolContext, KiboPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: KiboConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
