...
export function applyProviderAuthConfigPatch(cfg: KiboConfig, patch: unknown): KiboConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<KiboConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: KiboConfig, model: string): KiboConfig {
