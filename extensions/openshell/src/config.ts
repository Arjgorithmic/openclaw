...
import { buildPluginConfigSchema, type KiboPluginConfigSchema } from "kibo/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): KiboPluginConfigSchema {
